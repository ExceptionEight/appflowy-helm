...
{{- define "appflowy-web.wsUrl" -}}
{{- $wsScheme := ternary "wss" "ws" (eq .Values.global.scheme "https") -}}
{{- printf "%s://%s:%d/ws/v2" $wsScheme .Values.global.externalHost (.Values.global.externalPort | int) }}
{{- end }}
